...
if __name__ == "__main__":
    ...
    df = get_embeddings_df(folder="/data/users/mpilligua/hackathon/embeddings")
    
    df, kmeans = compute_KMeans(df, 10)
    df.to_pickle("/data/users/mpilligua/hackupc-2024/data/df2.pkl")
    with open("/data/users/mpilligua/hackupc-2024/data/kmeans.pkl", "wb") as f:
